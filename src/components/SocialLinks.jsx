              ...
              <div className="flex flex-col border-t border-green-800  justify-center md:justify-center items-center">
                <div className="max-w-md text-start">
                  ...
                  <div className="">
                    ...
                    <p className="text-[12px] md:max-w-[404px] md:text-lg font-medium mt-2 first-letter:capitalize">
                      The AI-powered journal can help users track their
                      thoughts, emotions, and daily experiences, providing
                      insights into their stress patterns and triggers. The AI
                      can analyze journal entries to identify trends and provide
                      personalized recommendations for managing stress more
                      effectively.
                    </p>
                  </div>
                </div>
                ...
                <div className="max-w-sm text-start">
                  ...
                  <div className="">
                    ...
                    <p className="text-[12px] md:max-w-md md:text-lg font-medium mt-2 first-letter:capitalize">
                      Based on the assessment, the platform can create
                      personalized stress management plans tailored to the
