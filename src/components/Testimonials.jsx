        ...
        <div>
          <div className="w-auto h-auto pb-0 overflow-auto z-0 inset-0">
            <div className="container mx-auto px-2 md:px-20 lg:px-36 flex flex-col items-center justify-center">
              <h2 className="text-xl md:text-3xl font-medium text-green-800 py-7">
                Testimonials
              </h2>
              ...
              <div
                className=" max-w-8xl rounded-lg md:h-64 w-full mt-20 flex flex-col md:flex-row-reverse  md:gap-x-2 "
                data-aos="fade-left"
              >
              ...
              <div
                className=" max-w-8xl rounded-lg md:h-64 w-full mt-20 flex flex-col md:flex-row  md:gap-x-2 transition duration-150 ease-in-out"
                data-aos="fade-right"
              >
              ...
              <div
                className=" max-w-8xl  mb-10 rounded-lg md:h-64 w-full mt-20 flex flex-col md:flex-row-reverse  md:gap-x-2 transition duration-150 ease-in-out"
                data-aos="fade-left"
              >
